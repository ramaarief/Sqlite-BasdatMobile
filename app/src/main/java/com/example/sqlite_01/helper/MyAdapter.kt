...
class MyAdapter(private val context: Activity, private val id: Array<String>,
                private val name: Array<String>, private val email: Array<String>, private val telepon: Array<String>)
    ...
    override fun getView(position: Int, view: View?, parent: ViewGroup): View {
        ...
        val teleponText = rowView.findViewById(R.id.textViewTelepon) as TextView

        idText.text = "Id: ${id[position]}"
        nameText.text = "Name: ${name[position]}"
        emailText.text = "Email: ${email[position]}"
        teleponText.text = "No Telepon: ${telepon[position]}"
        return rowView
    }
}