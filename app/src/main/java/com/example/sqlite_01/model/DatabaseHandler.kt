...
class DatabaseHandler(context: Context):
    ...
    fun addEmployee(emp: EmpModelClass):Long{
        ...
        contentValues.put(KEY_TELEPON,emp.userTelepon )
    ...
    fun viewEmployee():List<EmpModelClass>{
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                userTelepon = cursor.getString(cursor.getColumnIndex("telepon"))
                val emp= EmpModelClass(userId = userId, userName = userName, userEmail = userEmail, userTelepon = userTelepon)
                empList.add(emp)
